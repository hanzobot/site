...
export default function Layout({ children }: { children: ReactNode }) {
  return (
    ...
    >
      ...
      {/* Footer */}
      <footer className="border-t border-fd-border mt-auto py-6 sm:py-8 px-4">
        <div className="max-w-[1400px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-fd-muted-foreground">
