      ...
      <header className="text-center mb-8 animate-[fadeInUp_0.6s_ease-out]">
        ...
        <div className="relative max-w-[480px] mx-auto">
          ...
          <input
            ...
            className="w-full py-3.5 px-4 pl-11 rounded-xl border border-fd-border bg-[rgba(10,15,26,0.8)] text-fd-foreground text-base outline-none transition-all focus:border-neutral-600 focus:shadow-[0_0_0_3px_rgba(255,255,255,0.15)] placeholder:text-fd-muted-foreground"
          />
        </div>
      </header>

      <div className="flex justify-center items-center gap-3 mb-8 text-sm text-fd-muted-foreground">
        <span className="text-[#a3a3a3] font-medium">{skills.length} skills</span>
        <span className="opacity-40">·</span>
        <span className="text-[#a3a3a3] font-medium">{totalAuthors} contributors</span>
        <span className="opacity-40">·</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-4 mb-12">
        {filtered.map((skill) => (
          <div
            ...
            className="flex flex-col gap-3 p-5 rounded-2xl border border-fd-border bg-[rgba(10,15,26,0.7)] backdrop-blur-sm transition-all hover:border-neutral-600 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(255,255,255,0.12)]"
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-white to-neutral-300 flex items-center justify-center font-bold text-lg text-[#050810] shrink-0">
            ...
            <div className="mt-auto pt-3 border-t border-fd-border">
              <code className="text-xs font-mono text-[#a3a3a3] bg-[rgba(163,163,163,0.08)] px-2.5 py-1.5 rounded-lg block truncate">
