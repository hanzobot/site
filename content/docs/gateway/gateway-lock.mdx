---
title: "Gateway lock"
description: "Gateway singleton guard using the WebSocket listener bind"
---
...
## Operational notes
- If the port is occupied by *another* process, the error is the same; free the port or choose another with `bot gateway --port <port>`.
