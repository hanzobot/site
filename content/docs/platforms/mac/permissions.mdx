...
description: "macOS permission persistence (TCC) and signing requirements"
---
...
```bash
sudo tccutil reset Accessibility com.bot.mac
sudo tccutil reset ScreenCapture com.bot.mac
