...
- Install via CLI: `bot plugins install @bot/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `bot plugins install ./extensions/zalo`
   - From npm (if published): `bot plugins install @bot/zalo`
...
- Approve via:
  - `bot pairing list zalo`
  - `bot pairing approve zalo <CODE>`
...
- Example: `bot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `bot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `bot logs --follow`
