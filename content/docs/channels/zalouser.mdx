...
- Install via CLI: `bot plugins install @bot/zalouser`
- Or from a source checkout: `bot plugins install ./extensions/zalouser`
...
Approve via:
- `bot pairing list zalouser`
- `bot pairing approve zalouser <code>`
