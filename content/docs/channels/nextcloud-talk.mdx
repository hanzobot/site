...
```bash
bot plugins install @bot/nextcloud-talk
```

Local checkout (when running from a git repo):
```bash
bot plugins install ./extensions/nextcloud-talk
```
...
- Approve via:
  - `bot pairing list nextcloud-talk`
  - `bot pairing approve nextcloud-talk <CODE>`
