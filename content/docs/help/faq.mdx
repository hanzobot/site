...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Clawd, Flawd, and Krill use for models?](#what-do-bot-flawd-and-krill-use-for-models)
...
### What do Bot Flawd and Krill use for models

- **Bot + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-5`) - see [Anthropic](/providers/anthropic).
