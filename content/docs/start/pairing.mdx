...
“Pairing” is Bot’s explicit **owner approval** step.
...
Stored under `~/.bot/devices/`:
- `pending.json` (short-lived; pending requests expire)
- `paired.json` (paired devices + tokens)

### Notes

- The legacy `node.pair.*` API (CLI: `bot nodes pending/approve`) is a
