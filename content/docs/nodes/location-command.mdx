...
description: "Location command for nodes (location.get), permission modes, and background behavior"
---
...
- CLI: `bot nodes location get --node <id>`.
- Agent guidelines: only call when user enabled location and understands the scope.

## UX copy (suggested)
- Off: “Location sharing is disabled.”
- While Using: “Only when Bot is open.”
