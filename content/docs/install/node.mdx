...
description: "Node.js + npm install sanity: versions, PATH, and global installs"
---

# Node.js + npm (PATH sanity)

Bot’s runtime baseline is **Node 22+**.

If you can run `npm install -g bot@latest` but later see `bot: command not found`, it’s almost always a **PATH** issue: the directory where npm puts global binaries isn’t on your shell’s PATH.
