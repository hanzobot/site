---
title: "Gmail Pub/Sub -> Bot"
description: "Gmail Pub/Sub push wired into Bot webhooks via gogcli"
---
...
```bash
bot webhooks gmail setup \
  --account bot@gmail.com
```

Defaults:
- Uses Tailscale Funnel for the public push endpoint.
- Writes `hooks.gmail` config for `bot webhooks gmail run`.
...
Recommended: `bot webhooks gmail run` wraps the same flow and auto-renews the watch.
...
```bash
gog gmail watch status --account bot@gmail.com
gog gmail history --account bot@gmail.com --since <historyId>
```
...
```bash
gog gmail watch stop --account bot@gmail.com
