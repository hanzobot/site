---
title: "Groups"
description: "Group chat behavior across surfaces (WhatsApp/Telegram/Discord/Slack/Signal/iMessage/Microsoft Teams)"
---

Bot treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.
...
| Only specific groups | `groups: { "GROUP_ID": { ... } }` (no `"*"` key) |
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@bot", "bot", "\\+15555550123"],
          historyLimit: 50
        }
      }
    ]
