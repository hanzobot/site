...
This page ties together how Bot handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Bot keeps a
...
Bot separates the **prompt body** from the **command body**:
...
Bot can expose or hide model reasoning:
