...
description: "Streaming + chunking behavior (block replies, draft streaming, limits)"
---

Bot has two separate “streaming” layers:
...
When block streaming is enabled, Bot can **merge consecutive block chunks**
...
When draft streaming is active, Bot disables block streaming for that reply to avoid double-streaming.
