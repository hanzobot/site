...
- CLI helpers: `bot onboard`, `bot models list`, `bot models set <provider/model>`.
...
- CLI: `bot onboard --auth-choice token` (paste setup-token) or `bot models auth paste-token --provider anthropic`
...
- CLI: `bot onboard --auth-choice openai-codex` or `codex-cli`
...
- CLI: `bot onboard --auth-choice opencode-zen`
...
- CLI: `bot onboard --auth-choice gemini-api-key`
...
- Antigravity OAuth is shipped as a bundled plugin (`google-antigravity-auth`, disabled by default).
  - Enable: `bot plugins enable google-antigravity-auth`
  - Login: `bot models auth login --provider google-antigravity --set-default`
- Gemini CLI OAuth is shipped as a bundled plugin (`google-gemini-cli-auth`, disabled by default).
  - Enable: `bot plugins enable google-gemini-cli-auth`
  - Login: `bot models auth login --provider google-gemini-cli --set-default`
...
- CLI: `bot onboard --auth-choice zai-api-key`
...
- CLI: `bot onboard --auth-choice ai-gateway-api-key`
...
```bash
bot plugins enable qwen-portal-auth
bot models auth login --provider qwen-portal --set-default
```
...
- CLI: `bot onboard --auth-choice synthetic-api-key`
...
bot models set opencode/claude-opus-4-5
bot models list
```
