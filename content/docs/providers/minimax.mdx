---
title: "MiniMax"
description: "Use MiniMax M2.1 in Bot"
---
...
- Use `bot models list` and `bot models set minimax/MiniMax-M2.1` to switch.
...
- Running `bot configure` and selecting **MiniMax M2.1**, or
