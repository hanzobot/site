---
title: "Synthetic"
description: "Use Synthetic's Anthropic-compatible API in Bot"
---

Synthetic exposes Anthropic-compatible endpoints. Bot registers it as the
...
```bash
bot onboard --auth-choice synthetic-api-key
```
...
Note: Bot's Anthropic client appends `/v1` to the base URL, so use
