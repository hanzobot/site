---
title: "Qwen"
description: "Use Qwen OAuth (free tier) in Bot"
---
...
```bash
bot models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Bot will sync credentials
