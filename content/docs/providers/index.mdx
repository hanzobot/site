...
description: "Model providers (LLMs) supported by Bot"
---

Bot can use many LLM providers. Pick a provider, authenticate, then set the
...
1) Authenticate with the provider (usually via `bot onboard`).
