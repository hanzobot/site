...
const footerLinks = {
  platform: {
    ...
    items: [
      ...
      { title: 'Desktop VMs', href: '/docs/platforms' },
      { title: 'MCP Integration', href: '/docs/tools' },
  ...
  features: {
    title: 'Features',
    items: [
      { title: 'Local Runtime', href: '/docs/install' },
      { title: '100+ AI Models', href: '/docs/providers/models' },
      { title: 'Chat Integrations', href: '/integrations' },
      { title: 'Persistent Memory', href: '/docs/concepts/memory' },
      { title: 'Browser Control', href: '/docs/tools/browser' },
      { title: 'System Access', href: '/docs/tools/exec' },
    ],
  },
  solutions: {
    title: 'Solutions',
  ...
  resources: {
    ...
    items: [
      ...
      { title: 'Tutorials', href: '/docs/start' },
